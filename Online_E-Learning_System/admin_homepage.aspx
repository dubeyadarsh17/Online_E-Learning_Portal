<%@ Page Title="" Language="C#" MasterPageFile="~/AdminNavbar.Master" AutoEventWireup="true" CodeBehind="admin_homepage.aspx.cs" Inherits="Online_E_Learning_System.admin_homepage1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-left: 230px;">
        ...
        <script>
            ...
            var tteacher = parseInt(document.getElementById('<%=Label4.ClientID%>').innerHTML);
